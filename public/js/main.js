...
const getInfo = async(event) => {
    ...
    if(cityVal === ""){
        ...
        try{
            let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=bf2e157c86436b81e7fe73f628f7e51c`;
            ...
            city_name.innerHTML = 'please enter the cityname properly';
            datahide.classList.add('data_hide');
        }
    }
}
